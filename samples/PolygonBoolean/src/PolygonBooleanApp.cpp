...
vector<PolyLine2f> PolygonBooleanApp::makePolyWithHole() const
{
	...
	result.back().push_back( vec2( 200, 130 ) );
	result.back().push_back( vec2( 240, 170 ) );
	result.back().push_back( vec2( 280, 180 ) );
	result.back().push_back( vec2( 340, 120 ) );
	result.back().push_back( vec2( 370, 160 ) );
	result.back().push_back( vec2( 340, 200 ) );
	result.back().push_back( vec2( 410, 300 ) );
	result.back().push_back( vec2( 530, 260 ) );
	result.back().push_back( vec2( 540, 120 ) );
	result.back().push_back( vec2( 490, 80 ) );
	result.back().push_back( vec2( 290, 70 ) );
	result.back().push_back( vec2( 200, 130 ) );

	result.push_back( PolyLine2f() );
	result.back().push_back( vec2( 400, 200 ) );
	result.back().push_back( vec2( 420, 140 ) );
	result.back().push_back( vec2( 480, 190 ) );
	result.back().push_back( vec2( 440, 220 ) );
	result.back().push_back( vec2( 400, 200 ) );
	return result;
}
...
vector<PolyLine2f> PolygonBooleanApp::makeStar() const
{
	...
	result.back().push_back( vec2( 350, 100 ) );
	result.back().push_back( vec2( 200, 150 ) );
	result.back().push_back( vec2( 350, 200 ) );
	result.back().push_back( vec2( 400, 350 ) );
	result.back().push_back( vec2( 450, 200 ) );
	result.back().push_back( vec2( 600, 150 ) );
	result.back().push_back( vec2( 450, 100 ) );
	result.back().push_back( vec2( 400, -50 ) );
	return result;
}
