...
class AccordionItem {
  public:
	AccordionItem( ci::Timeline &timeline, float x, float y, float height, float contractedWidth, float expandedWidth, ci::gl::TextureRef image, std::string title, std::string subtitle );
	void update();
	void draw();
