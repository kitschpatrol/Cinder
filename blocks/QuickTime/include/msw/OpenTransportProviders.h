...
class TInternetServices : public TProvider {
  public:
	...
	OSStatus Query( char *name, UInt16 qClass, UInt16 qType, char *buf, OTByteCount buflen, void **argv, OTByteCount argvlen, OTFlags flags )
	{
...
inline void DDPNBPAddress::Init( UInt16 net, UInt8 node, UInt8 socket, UInt8 type )
{
	fAddressType = AF_ATALK_DDPNBP;
	SetNetwork( net );
	SetNode( node );
...
#define OTCompare48BitAddresses( p1, p2 ) \
	( *(const UInt32 *)( (const UInt8 *)( p1 ) ) == *(const UInt32 *)( (const UInt8 *)( p2 ) ) && *(const UInt16 *)( ( (const UInt8 *)( p1 ) ) + 4 ) == *(const UInt16 *)( ( (const UInt8 *)( p2 ) ) + 4 ) )
...
#define OTCompare8022SNAP( p1, p2 ) \
	( *(const UInt32 *)( (const UInt8 *)( p1 ) ) == *(const UInt32 *)( (const UInt8 *)( p2 ) ) && *( ( (const UInt8 *)( p1 ) ) + 4 ) == *( ( (const UInt8 *)( p2 ) ) + 4 ) )
...
#define OTIs48BitBroadcastAddress( p1 ) \
	( *(UInt32 *)( (UInt8 *)( p1 ) ) == 0xffffffff && *(UInt16 *)( ( (UInt8 *)( p1 ) ) + 4 ) == 0xffff )
