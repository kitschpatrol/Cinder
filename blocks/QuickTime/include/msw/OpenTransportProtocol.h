...
class OTConfiguration {
  public:
	...
	OTConfigurationRef PushNthChild( OTItemCount index, const char *path, OSStatus *errPtr )
	{
...
#endif
{
  ...
  public:
	...
	virtual void _MDECL HandleSystemEvent( OTEventCode event, OTResult result, void *cookie ) = 0;

	virtual OSStatus _MDECL Configure( OTConfigurationRef ) = 0;
	virtual OSStatus _MDECL CreateStream( OTConfigurationRef, OTOpenFlags, OTNotifyUPP, void *contextPtr ) = 0;
};
