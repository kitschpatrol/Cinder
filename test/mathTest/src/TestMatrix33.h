...
template <typename T>
void TestMatrix33( std::ostream &os )
{
	...
	// operator T*() { return (T*)m; }
	{
		...
		MatT c0( 2, 4, 6, 10, 12, 14, 18, 20, 22 );

		MatT m0( 1, 2, 3, 5, 6, 7, 9, 10, 11 );
	...
	// operator const T*() const { return (const T*)m; }
	{
		...
		T cdata[16] = {
			(T)1, (T)2, (T)3, (T)5, (T)6, (T)7, (T)9, (T)10, (T)11
		};
	...
	// bool equalCompare( const Matrix33<T>& rhs, T epsilon ) const;
	{
		...
		MatT c0( (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04, (T)1.0e-04 );

		MatT m0( (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04, (T)3.0e-04 );

		MatT m1( (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04, (T)1.5e-04 );
	...
	// bool operator==( const Matrix33<T> &rhs );
	{
		...
		MatT c0( 1, 2, 3, 4, 5, 6, 7, 8, (T)1.234e-06 );

		MatT m0( 1, 2, 3, 4, 5, 6, 7, 8, (T)1.235e-06 );
	...
	// bool operator!=( const Matrix33<T> &rhs );
	{
		...
		MatT m0( 2, 2, 3, 4, 5, 6, 7, 8, (T)1.235e-06 );
	...
	// Matrix33<T>& operator/=( T rhs );
	{
		...
		MatT m0( 2, 4, 6, 10, 12, 14, 18, 20, 22 );
	...
	// Matrix33<T>& operator+=( T rhs );
	{
		...
		MatT c0( (T)1.025, (T)2.025, (T)3.025, (T)5.025, (T)6.025, (T)7.025, (T)9.025, (T)10.025, (T)11.025 );
	...
	// Matrix33<T>& operator-=( T rhs );
	{
		...
		MatT m0( (T)1.025, (T)2.025, (T)3.025, (T)5.025, (T)6.025, (T)7.025, (T)9.025, (T)10.025, (T)11.025 );
	...
	// Vec3<T> getColumn( int col ) const;
	{
		...
		result = ( c0.getColumn( 0 ) == Vec3<T>( 1, 2, 3 ) ) && ( c0.getColumn( 1 ) == Vec3<T>( 5, 6, 7 ) ) && ( c0.getColumn( 2 ) == Vec3<T>( 9, 10, 11 ) );
	...
	// Vec3<T> getRow( int row ) const;
	{
		...
		result = ( c0.getRow( 0 ) == Vec3<T>( 1, 5, 9 ) ) && ( c0.getRow( 1 ) == Vec3<T>( 2, 6, 10 ) ) && ( c0.getRow( 2 ) == Vec3<T>( 3, 7, 11 ) );
	...
	// void getColumns( Vec3<T> *c0, Vec3<T> *c1, Vec3<T> *c2 ) const;
	{
		...
		result = ( v0 == Vec3<T>( 1, 2, 3 ) ) && ( v1 == Vec3<T>( 5, 6, 7 ) ) && ( v2 == Vec3<T>( 9, 10, 11 ) );
	...
	// void getRows( Vec3<T> *r0, Vec3<T> *r1, Vec3<T> *r2 ) const;
	{
		...
		result = ( v0 == Vec3<T>( 1, 5, 9 ) ) && ( v1 == Vec3<T>( 2, 6, 10 ) ) && ( v2 == Vec3<T>( 3, 7, 11 ) );
	...
	// Matrix22<T> subMatrix22( int row, int col ) const;
	{
		...
		MatT c0( 1, 2, 3, 5, 6, 7, 9, 10, 11, true );
		...
		result = ( m22_00 == c0.subMatrix22( 0, 0 ) ) && ( m22_01 == c0.subMatrix22( 0, 1 ) ) && ( m22_10 == c0.subMatrix22( 1, 0 ) ) && ( m22_11 == c0.subMatrix22( 1, 1 ) );
	...
	// T determinant() const;
	{
		...
		MatT m0(
		    (T)0.009505, (T)0.848196, (T)-0.529596, (T)-0.999570, (T)0.022748, (T)0.018494, (T)0.027734, (T)0.529193, (T)0.848048, true );
	...
	// Matrix33<T> lowerTriangular() const;
	{
		...
		MatT c0( 1, 0, 0, 5, 6, 0, 9, 10, 11, true );

		MatT m0( 1, 2, 3, 5, 6, 7, 9, 10, 11, true );
	...
	// Matrix33<T> upperTriangular() const;
	{
		...
		MatT c0( 1, 2, 3, 0, 6, 7, 0, 0, 11, true );
	...
	// void invert (T epsilon = FLT_MIN );
	{
		...
		MatT c0(
		    (T)0.000000105208, (T)0.000003012750, (T)-0.000000298135, (T)-0.000000005514, (T)-0.000001024409, (T)1.889669795292, (T)0.000005693105, (T)54.071754880366, (T)-2.324348789360 );

		MatT m0(
		    (T)0.009505e9, (T)0.848196, (T)-0.529596, (T)-0.999570, (T)0.022748, (T)0.018494, (T)0.027734, (T)0.529193, (T)0.848048e-8 );
	...
	// Vec3<T> transformVec( const Vec3<T> &rhs ) const;
	{
		...
		MatT c0(
		    (T)0.45399, (T)-0.89101, (T)0.00000, (T)0.89101, (T)0.45399, (T)0.00000, (T)0.00000, (T)0.00000, (T)1.00000, true );
	...
	// void rotate( const Vec3<T> &axis, T radians );
	{
		...
		MatT c0( (T)1.000000000000000, (T)0.000000000000000, (T)0.000000000000000, (T)0.000000000000000, (T)0.840963470480837, (T)-0.541091897293636, (T)0.000000000000000, (T)0.541091897293636, (T)0.840963470480837, true );
	...
	// void rotate( const Vec3<T> &eulerRadians );
	{
		...
		MatT c0(
		    (T)0.091142486334637, (T)0.428791685462663, (T)-0.898794046299167, (T)-0.730490309010667, (T)0.642199351624628, (T)0.232301315567534, (T)0.676813826414798, (T)0.635387821138395, (T)0.371759816444386 );
	...
	// void scaleA( T s );
	{
		...
		MatT c0( 5, 0, 0, 0, 5, 0, 0, 0, 5 );

		MatT m0( 1, 0, 0, 0, 1, 0, 0, 0, 1 );
	...
	// static Matrix33<T> createRotation( const Vec3<T> &from, const Vec3<T> &to, const Vec3<T> &worldUp );
	{
		...
		MatT c0( (T)0.707106781186548, (T)0.000000000000000, (T)-0.707106781186548, (T)0.000000000000000, (T)1.000000000000000, (T)0.000000000000000, (T)0.707106781186548, (T)0.000000000000000, (T)0.707106781186548, true );
	...
	// Matrix33 to Quaternion/Quaternion to Matrix33
	{
		...
		Matrix44<T> c44(
		    (T)0.091142486334637, (T)0.428791685462663, (T)-0.898794046299167, 0, (T)-0.730490309010667, (T)0.642199351624628, (T)0.232301315567534, 0, (T)0.676813826414798, (T)0.635387821138395, (T)0.371759816444386, 0, 0.000000000000000, 0.000000000000000, 0.000000000000000, 1 );
