...
void BufferTextureApp::setupBuffer()
{
	std::array<vec3, 12> vertices = {
		vec3( -1.0, 1.0, 0.0 ), vec3( 1.0, 0.0, 0.0 ), vec3( -1.0, -1.0, 0.0 ), vec3( 0.0, 1.0, 0.0 ), vec3( 1.0, -1.0, 0.0 ), vec3( 0.0, 0.0, 1.0 ), vec3( -1.0, 1.0, 0.0 ), vec3( 1.0, 0.0, 0.0 ), vec3( 1.0, -1.0, 0.0 ), vec3( 0.0, 0.0, 1.0 ), vec3( 1.0, 1.0, 0.0 ), vec3( 1.0, 1.0, 1.0 )
	};
